...
struct AppStats {
    ...
    float pitch = 0.0f;              ///< Filter pitch (rad; mode-dependent reference).
    float roll = 0.0f;               ///< Filter roll (rad; mode-dependent reference).
    float yaw = 0.0f;                ///< Gyro-relative yaw (rad), Cube/Level.
