...
//
// All lane, coordinator, registry and shell-service ownership moved into
// runtime.cpp at the S4 dispatch slice. This file only hands control to the
// runtime, which boots the board (board -> DisplayService -> ConsoleService ->
